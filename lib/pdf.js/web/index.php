...
if(empty($rid) || empty($rfname)) { // illegal access
...
$RD_ONLY=false; // default: false (protect download/print)
$GUEST_VIEW=false; // default: false (protect guest access)
...
<html dir="ltr" mozdisallowselectionprint>
  <head>
	...
	<?PHP
	// [SJH] Added to hide download button
	
	/* 	prevent print: make empty page
	...
	*/
	...
	<link rel="resource" type="application/l10n" href="<?=$_SESSION['app.url']?>/lib/pdf.js/web/locale/locale.properties">
	<script src="<?=$_SESSION['app.url']?>/lib/pdf.js/build/pdf.js"></script>
	
	<script src="viewer.js"></script>
	
	<script src="<?=$_SESSION['app.url']?>/lib/jquery/jquery-3.4.1.min.js"></script><!-- to remove download: https://stackoverflow.com/questions/17547956/how-to-make-pdf-undownloadable-using-pdf-js -->
